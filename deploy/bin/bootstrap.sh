...
echo "  4. TEKSHIRING:  deploy/bin/oldindan-tekshir.sh ${MUHIT}"
echo "  5. Kodni push qiling va: deploy/bin/deploy.sh ${MUHIT} <ref>"
echo
echo "  4-qadam MUHIM: shu skript namunadan qolgan qiymatlarni"
echo "  (password=REPLACE, example.uz, namunaviy bcrypt xeshi) ANIQ"
echo "  aytadi. Busiz ular joylashtirishning oxirida — yoki umuman"
echo "  ko'rinmasdan — chiqadi."
